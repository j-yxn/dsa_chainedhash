...
public class DoublyLinkedList implements IDoublyLinkedList {
    ...
    public void printReverse() {
      ...
      public void remove(int index) {
        if (index >= length) {
            IndexOutOfBoundsException e = new IndexOutOfBoundsException("Index: " + index + ", Size: " + length);
            throw e;
        }
        ...
        if (index == 0) {
            ...
            if (removeNode.next != null) {  //not the end of the list, so set following node's prev
